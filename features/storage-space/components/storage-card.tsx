...
const styles = StyleSheet.create({
  ...
  badgeText: { color: Theme.colors.background, fontSize: 12, fontWeight: '600' },
  content: { padding: 15 },
  ...
  priceLabel: { fontSize: 11, color: Theme.colors.textMuted, textTransform: 'uppercase', fontWeight: '600' },
